...
for i_moor = 1:9;
  for i_interp = 1:2;
    ...
    %  Read in file and if serial number is not already in intermediate grid
    ...
    %% Interpolate pressure for instruments without pressure in temp structure
    ...
    if params.print
      ...
      disp('This is a chance to look at the data and stop if things look bad.')
    ...
    switch i_interp
      ...
      case 2
        % pchip
        TT = moorInterpZ(TT,z,time,'pchip');
    end
    ...
    if ~isempty(SS.psal)
      switch i_interp
        ...
        case 2
          % pchip
          SS = moorInterpZ(SS,z,time,'pchip');
      end
    end
    ...
    switch i_interp
      ...
      case 2
        % pchip
        UV = moorInterpZ(UV,z,time,'pchip');
    end
    ...
    switch i_interp
      case 1
        ...
        f_out = [params.pathout params.channel '/' params.moor_name '/' ...
          params.moor_name '_linearInterp.mat'];
      case 2
        % pchip
        f_out = [params.pathout params.channel '/' params.moor_name '/' ...
          params.moor_name '_pchipInterp.mat'];
    end
    
    if ~isempty(SS.psal)
      save(f_out,'TT','SS','UV','params')
    else
