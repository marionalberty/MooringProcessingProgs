...
main_path = '/Users/janetsprintall/JanetsDocuments/philippines/data/moorings/mooring_data/';
...
% deployment times
start_time=datenum(2007,12,03,03,30,00);
end_time = datenum(2009,03,16,21,30,00);
...
for inf = 1:nf
    ...
    clear t
infile = [main_path filenr fname{inf}]
