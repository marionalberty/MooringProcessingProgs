  ...
  for i_bot = 1:2
    for i_xpass = 1:3
      ...
      load([driveName dataPath 'Solomon_M2b/Solomon_M2b_' bot '_' surf ...
        '.mat'])
      UV_2 = UV;    SS_2 = SS;      TT_2 = T4S;    RHO_2 = RHO;
      params_2 = params;
      ...
      rho_2 = interp1(TT_2.time,M_filt.sgth(i_s,:)',time)';
      z_2 = TT_2.z(i_s);
      ...
      %% Rotate and put velocity data in grid
      % M1
      [XSV(1:numel(UV_1.z),i_d1,:),ASV(1:numel(UV_1.z),i_d1,:)] = ...
        uvrot(U_1,V_1,phi_12);
      
      % M2
      [XSV(1:numel(UV_2.z),i_d2-1,:),ASV(1:numel(UV_2.z),i_d2-1,:)] = ...
        uvrot(U_2,V_2,phi_12);
      [XSV(1:numel(UV_2.z),i_d2,:),ASV(1:numel(UV_2.z),i_d2,:)] = ...
        uvrot(U_2,V_2,phi_23);
      
      % M3
      [XSV(1:numel(UV_3.z),i_d3,:),ASV(1:numel(UV_3.z),i_d3,:)] = ...
        uvrot(U_3,V_3,phi_23);
      ...
      % Insert M2
      RHO(z >= z_2(1) & z <= z_2(end),i_d2-1,:) = rho_2;
      TEM(z >= z_2(1) & z <= z_2(end),i_d2-1,:) = t_2;
      SAL(z >= z_2(1) & z <= z_2(end),i_d2-1,:) = s_2;
      ...
      f_out = [driveName dataPath params_1.channel '_' xpass ...
